...
?>
    ...
    <main class="contenedor seccion">
        ...
        <picture>
            <source srcset="build/img/destacada3.webp" type="imge/webp">
            <source srcset="build/img/destacada3.jpg" type="imge/jpeg">
            <img src="build/img/destacada3.jpg" alt="imagen formulario">
        </picture>
        ...
        <form action="" class="formulario">
            ...
            <fieldset>
                ...
                <input type="number" placeholder="Tu Presupuesto" min="0" id="presupuesto">
            </fieldset>
